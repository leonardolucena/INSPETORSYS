...
@JsonKey(name: 'accessToken') String get accessToken;@JsonKey(name: 'tokenType') String? get tokenType;@JsonKey(name: 'expiresIn') int? get expiresIn; UserDto get user;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,accessToken,tokenType,expiresIn,user);

@override
String toString() {
  return 'LoginResponseDto(accessToken: $accessToken, tokenType: $tokenType, expiresIn: $expiresIn, user: $user)';
}
...
@useResult
$Res call({
@JsonKey(name: 'accessToken') String accessToken,@JsonKey(name: 'tokenType') String? tokenType,@JsonKey(name: 'expiresIn') int? expiresIn, UserDto user
});
...
/// Create a copy of LoginResponseDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = null,Object? tokenType = freezed,Object? expiresIn = freezed,Object? user = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'accessToken')  String accessToken, @JsonKey(name: 'tokenType')  String? tokenType, @JsonKey(name: 'expiresIn')  int? expiresIn,  UserDto user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginResponseDto() when $default != null:
return $default(_that.accessToken,_that.tokenType,_that.expiresIn,_that.user);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'accessToken')  String accessToken, @JsonKey(name: 'tokenType')  String? tokenType, @JsonKey(name: 'expiresIn')  int? expiresIn,  UserDto user)  $default,) {final _that = this;
switch (_that) {
case _LoginResponseDto():
return $default(_that.accessToken,_that.tokenType,_that.expiresIn,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'accessToken')  String accessToken, @JsonKey(name: 'tokenType')  String? tokenType, @JsonKey(name: 'expiresIn')  int? expiresIn,  UserDto user)?  $default,) {final _that = this;
switch (_that) {
case _LoginResponseDto() when $default != null:
return $default(_that.accessToken,_that.tokenType,_that.expiresIn,_that.user);case _:
  return null;
...
class _LoginResponseDto implements LoginResponseDto {
  const _LoginResponseDto({@JsonKey(name: 'accessToken') required this.accessToken, @JsonKey(name: 'tokenType') this.tokenType, @JsonKey(name: 'expiresIn') this.expiresIn, required this.user});
...
/// Create a copy of LoginResponseDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? tokenType = freezed,Object? expiresIn = freezed,Object? user = null,}) {
